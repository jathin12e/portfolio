        ...
        <div className='Content'>
            ...
            <p className='content'>
               ...
               <div className='ml-2 btn1'>
                    <a href="https://res.cloudinary.com/dgzuiurhr/raw/upload/v1727782457/jathinresume543_1_kysooq.docx" target='_blanck'><button className='button'  >Download CV</button></a>
